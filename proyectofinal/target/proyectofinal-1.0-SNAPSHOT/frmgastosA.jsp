...
<html lang="es">
    ...
    <body>
        <div class="container">
            <h1><b><center>Formulario de Gastos</center></b></h1>
            <br>
                ...
                <form action="ComunControlador" method="post" >
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="descripcion" 
                               value="${gastos.descripcion}" placeholder="Escriba una descripcion del gasto">
                    </div>         
                    <div class="form-group">
                        <label for="" class="form-label">Monto de gasto</label>
                        <input type="number" class="form-control" name="monto_gasto" 
                               value="${gastos.monto_gastado}" step="0.01" placeholder="Ingrese el monto a gastar">
                    </div>
                    <br>
